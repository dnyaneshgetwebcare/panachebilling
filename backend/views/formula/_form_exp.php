...
<div class="formula-master-form">
 ...
 <?php if($model->expense_category!=''){
           	echo $form->field($model, "expense_category")->dropDownList($model_exp);
           }else{ echo $form->field($model, "expense_category")->dropDownList($model_exp,['prompt'=>'Select']); } ?>
...
<?= $form->field($model, "expense_per")->textInput(['maxlength' => true,'onkeyup'=> 'add_total_payment(this.id)','placeholder'=>'0.00','type' => 'number','min'=>0,'max' => 100]) ?>
