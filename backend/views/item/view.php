                    ...
                    <div class="col-12">
                        <div class="card">
                            <ul class="nav nav-tabs profile-tab" role="tablist">
                                <li class="nav-item"> <a class="nav-link active" data-toggle="tab" href="#details" role="tab" style="font-size: large;">Item details</a> </li>
                                    ...
                                    <table class="table color-table red-table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><a  target="_blank" rel="noopener noreferrer" href="index.php?r=customer%2Fview&id=<?= $booking_item->booking['customer_id']; ?>"><?= $booking_item->booking->customer['name']; ?></a></td>
